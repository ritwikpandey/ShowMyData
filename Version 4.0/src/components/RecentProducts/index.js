...
export default class RecentProduct extends React.Component {
    constructor(props){
        super(props)
        this.state={
            showFrom:0,
        ...
        return (
            <div style={{ width: '80vw', padding: '0 10vw' }}>
                ...
                {data.length !== 0 && <div style={{ margin: 0, textAlign: 'left', height: '4vh', fontSize: '16px', padding: '4px 0vw', fontWeight: '400', fontFamily: 'Open Sans' }}>
                    <p style={{ float: 'left', height: '4vh', margin: 0, color: '#545558', fontFamily: 'Open Sans', fontWeight: '600' }}>Products you viewed recently</p>
                </div> }
                <div style={{

...
const Header = ({showRecommendation, onClick}) =>(
      ...
      <div id="mainNav">
          <nav aria-label="account type">
              <div class="html5nav" id="tabNav">
                  <ul>
                      <li class="active">
                          <a hreff="#" tabindex="-1" role="presentation" class="tabNavLink" id="tabNavPersonal" name="tabNavPersonal">
                              <span class="hidden">selected</span>
                              Personal
                        <img alt="" src="https://www01.wellsfargomedia.com/assets/images/css/template/homepage/homepage-caret-selector.svg" />
                          </a>
                      </li>
                      <li>
                          <a hreff="/biz/" class="tabNavLink" id="tabNavSmallBusiness" name="tabNavSmallBusiness" title="Small Business. Serving businesses with up to $5 million in annual revenue.">Small Business</a>
                      </li>
                      <li>
                          <a hreff="/com/" class="tabNavLink" id="tabNavCommercial" name="tabNavCommercial" title="Commercial. Serving businesses with over $20 million in annual revenue">Commercial</a>
                      </li>
                  </ul>
              </div>
              <div id="headerTools">
                  <nav role="presentation">
                      <ul>
                          <li>
                              <a hreff="/financial-education/">Financial Education</a>
                          </li>
                          <li>
                              <a hreff="/about/">About Wells Fargo</a>
                          </li>
                      </ul>
                  </nav>
              </div>

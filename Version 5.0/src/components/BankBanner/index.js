...
const BankBanner = ()=>(
    ...
    <div style={{ position: 'relative', height: '50vh', width: '80vw', textAlign: 'left' }}>
      <p style={{ fontFamily: 'Open Sans', fontWeight: '600' }}>Wells Fargo Debit and Prepaid Cards</p>
      <div style={{ position: 'absolute', height: '40vh', width: '55%' }} className="bankCardBanner">
      </div>
      ...
      <br />
        <h4 style={{ fontFamily: 'Open Sans', color: '#b61235', textAlign: 'left', marginLeft: '2vw' }}>Misplaced your debit card?</h4>
        <p style={{ fontFamily: 'Open Sans', color: '#545558', textAlign: 'left', margin: '0 5vw 0 2vw' }}>Pause it — then turn it on again when you find it</p>
        <br />
